...
<div class="form-wrapper">
	...
	<form class="needs-validation" action="<?php echo site_url('index.php/Utilisateur/enregistrer?role=3'); ?>" method="post"
		...
		<div class="card-body card-block">
			<div class="row form-group">
				...
				<div class="col-12 col-md-9">
					<select name="civilite" id="select" class="form-control" required>
			...
			<div class="form-group">
				<div class="input-group">
					...
					<input type="text" id="username" name="pseudo" placeholder="Pseudo" class="form-control" required>
					<div class="valid-feedback">
						Ok !
					</div>
					<div class="invalid-feedback">
